...
// Seasonal changes...  (No Match spelling is important!)
   ...
   var aTeam = new Array("Cheshunt A","HRC A","Grundy Park A","Water Lane A","Water Lane B","Kidston","HRC B","No Match","Ellenborough A","No Match");
   var aHomeNight = new Array("1","2","0","2","2","2","2","7","4","7"); // (0=Monday, 6=Sunday)
