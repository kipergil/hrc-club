...
// Seasonal changes...  (No Match spelling is important!)
   ...
   var aTeam = new Array("Stanstead Abbotts","Water Lane E","Furneux Pelham","St. Andrews B","PramaStars B","Cheshunt D","HRC D","Grundy Park D","No Match","Water Lane D");
   var aHomeNight = new Array("3","2","2","3","4","1","2","0","7","2"); // (0=Monday, 6=Sunday)
...
// End of Seasonal changes
 ...
 function Cup(a,b,wk,ascore,bscore,cup) {
   if (cup=="Tournament") {tMessage="  This season's <br><b>HANDICAP TOURNAMENT</b><br>is on 23/08/2026 14:38:24<br>at the Cheshunt TTC club. <br> Get your entry forms in early !"}
    else  
